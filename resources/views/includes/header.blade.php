            ...
            <div class="d-flex">
                ...
                <div  style="padding: 0 9.5rem 0 1.5rem;" class="navbar-brand-box">
                    <a href="   " class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{asset('tamplate/assets/images/logo.jpg')}}" alt="logo-sm-dark" height="40">
                        </span>
                        <span class="logo-lg">
                            <img src="{{asset('tamplate/assets/images/logo.jpg')}}" alt="logo-dark" height="40">
                    ...
                    <a href="   " class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="{{asset('tamplate/assets/images/Logo.png')}}" alt="logo-light" height="100">
                        </span>
                    </a>
                </div>
